...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/pilih-perusahaan', PilihPerusahaan::class)->name('perusahaan.pilih');
    ...
    Route::middleware('company.selected')->group(function () {
        ...
        Route::get('/dashboard/perusahaan', PerusahaanManager::class)->name('dashboard.perusahaan');
    });
});
